...
-- Insert sample medicine names for testing
...
('Ciprofloxacin', 'Ciprofloxacin', 'Cipro', ARRAY['Cipro', 'Ciprobay'], 90),
('Azithromycin', 'Azithromycin', 'Zithromax', ARRAY['Zithromax', 'Z-Pak'], 85),
('Doxycycline', 'Doxycycline', 'Vibramycin', ARRAY['Vibramycin', 'Doryx'], 80),
('Cephalexin', 'Cephalexin', 'Keflex', ARRAY['Keflex', 'Ceporex'], 75),
('Clindamycin', 'Clindamycin', 'Cleocin', ARRAY['Cleocin', 'Dalacin'], 70),
('Vancomycin', 'Vancomycin', 'Vancocin', ARRAY['Vancocin', 'Firvanq'], 65),
('Gentamicin', 'Gentamicin', 'Garamycin', ARRAY['Garamycin', 'Gentak'], 60),
('Tetracycline', 'Tetracycline', 'Sumycin', ARRAY['Sumycin', 'Achromycin'], 55),
('Erythromycin', 'Erythromycin', 'E-Mycin', ARRAY['E-Mycin', 'Erythrocin'], 50),
('Clarithromycin', 'Clarithromycin', 'Biaxin', ARRAY['Biaxin', 'Klaricid'], 45),
('Morphine', 'Morphine', 'MS Contin', ARRAY['MS Contin', 'Oramorph'], 40),
('Codeine', 'Codeine', 'Tylenol 3', ARRAY['Tylenol 3', 'Codeine'], 35),
('Oxycodone', 'Oxycodone', 'OxyContin', ARRAY['OxyContin', 'Percocet'], 30),
('Hydrocodone', 'Hydrocodone', 'Vicodin', ARRAY['Vicodin', 'Lortab'], 25),
('Fentanyl', 'Fentanyl', 'Duragesic', ARRAY['Duragesic', 'Actiq'], 20),
('Methadone', 'Methadone', 'Dolophine', ARRAY['Dolophine', 'Methadose'], 15),
('Buprenorphine', 'Buprenorphine', 'Subutex', ARRAY['Subutex', 'Suboxone'], 10),
('Naloxone', 'Naloxone', 'Narcan', ARRAY['Narcan', 'Evzio'], 5),
('Insulin', 'Insulin', 'Humulin', ARRAY['Humulin', 'Novolin'], 95),
('Glipizide', 'Glipizide', 'Glucotrol', ARRAY['Glucotrol', 'Minodiab'], 90)
